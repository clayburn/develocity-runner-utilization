...
dependencies {
    ...
    implementation("com.fasterxml.jackson.jaxrs:jackson-jaxrs-json-provider:2.22.2")
...
application {
    mainClass.set("me.clayjohnson.runnerutilization.AppKt")
}

val develocityVersion = "2024.1"
